...
export let ApexData1: ApexOptions | any = {
    series: [
        {
...
export let ApexData2: ApexOptions | any = {
    series: [
        {
...
export let ApexData3: ApexOptions | any = {
    series: [
        {
            data: [7, 5, 7, 3, 5, 2, 5, 3, 9, 6, 5, 9],
            name:'Ethereum Price'
        }
    ],
}
export let ApexData4: ApexOptions | any = {
    series: [
        {
            data: [15, 6, 16, 11, 12, 15, 10, 19, 16, 13, 12],
            name:'Ethereum Price'
        }
    ],
}