...
`<div>
    <ul class="list-group">
        <li class="list-group-item d-flex align-items-center">
            <img alt="avatar" class="wd-30 rounded-circle mg-r-15"
                src="./assets/img/users/2.jpg">
            <div>
                <h6 class="tx-13 tx-inverse tx-semibold mg-b-0">Adrian
                    Monino</h6><span
                    class="d-block tx-11 text-muted">Premium Member</span>
            </div>
        </li>
        <li class="list-group-item d-flex align-items-center">
            <img alt="avatar" class="wd-30 rounded-circle mg-r-15"
            ...
            <div>
                <h6 class="tx-13 tx-inverse tx-semibold mg-b-0">Joel Mendez
                </h6><span class="d-block tx-11 text-muted">Premium
                    Member</span>
            </div>
        </li>
        <li class="list-group-item d-flex align-items-center">
            ...
            <div>
                <h6 class="tx-13 tx-inverse tx-semibold mg-b-0">Marianne
                    Audrey</h6><span
                    class="d-block tx-11 text-muted">Premium Member</span>
            </div>
        </li>
...
`<div>
    <ul class="list-group">
        ...
        <li class="list-group-item list-group-item-info">A simple info list
            group item</li>
        <li class="list-group-item list-group-item-light">A simple light
            list group item</li>
        ...
        <li>Cras justo odio
            <ul class="list-group checked">
                <li class="list-group-item"><i
                        class="fe fe-check mr-3 tx-13"
                        aria-hidden="true"></i>Lorem </li>
                <li class="list-group-item"><i
                        class="fe fe-check mr-3 tx-13"
                        aria-hidden="true"></i>established</li>
                <li class="list-group-item"><i
                        class="fe fe-check mr-3 tx-13"
                        aria-hidden="true"></i>Contrary</li>
            </ul>
        </li>
        <li>Porta ac consectetur ac</li>
        <li>Vestibulum at eros</li>
